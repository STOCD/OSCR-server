...
class SystemApi:
    ...
    def system_latest(
        ...
        _param = self._system_latest_serialize(
    ...
    @validate_call
    def system_latest_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def system_latest_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
