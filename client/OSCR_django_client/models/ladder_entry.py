...
class LadderEntry(BaseModel):
    ...
    ladder_rank: Optional[StrictInt] = None
    player: Annotated[str, Field(min_length=1, strict=True)]
    data: Dict[str, Any]
    combatlog: StrictInt
    ladder: StrictInt
    __properties: ClassVar[List[str]] = ["id", "date", "rank", "ladder_rank", "player", "data", "combatlog", "ladder"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "date": obj.get("date"),
            "rank": obj.get("rank"),
            "ladder_rank": obj.get("ladder_rank"),
